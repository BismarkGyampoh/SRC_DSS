    ...
    <header class="app-header">
        <div class="app-header-inner">
            ...
            <nav class="app-nav" id="appNav">
                ...
                <a class="app-nav-link <?= $currentPage === '/dss/views/feedback.php' ? 'active' : '' ?>" href="/dss/views/feedback.php">
            ...
            <div class="app-header-actions">
                ...
                <?php if (isset($_SESSION['user_id'], $_SESSION['user_role'])): ?>
                    <a href="/dss/logout.php" class="app-icon-btn" title="Logout" aria-label="Logout">
                        <i class="material-icons">exit_to_app</i>
                    </a>
                <?php else: ?>
                    <a href="/dss/login.php" class="app-icon-btn" title="Executive Login" aria-label="Executive Login">
