...
<?php else: ?>
    <div class="bento-card">
        <div class="bento-card-header"><i class="material-icons">account_balance_wallet</i> Budget Overview</div>
        <p class="bento-subtext">Budget overview for <?= $academicTerm ?>.</p>
    </div>
