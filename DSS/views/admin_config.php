...
<?php else: ?>
    <div class="bento-card bento-span-full">
        <div class="bento-card-header"><i class="material-icons">settings</i> System Settings</div>
        <p class="bento-subtext">Manage users, activity logs, and database tools.</p>

            <div class="action-button-row" style="margin-top: 1.5rem;">
                <a href="activity_logs.php" class="btn purple"><i class="material-icons left">history</i>View Activity Logs</a>
            </div>
        </div>
    </div>

    <div class="bento-card bento-span-full">
        <div class="bento-card-header"><i class="material-icons">people</i> User Accounts</div>
        <p class="bento-subtext">Add, change, or remove user accounts.</p>

            <form method="post" action="../controllers/action_admin_manage_users.php" style="margin-top: 1.5rem;">
                <?= $csrfField ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if ((int) $user['user_id'] !== (int) $_SESSION['user_id']): ?>
                                        <form method="post" action="../controllers/action_admin_manage_users.php" style="display: inline;">
                                            <?= $csrfField ?>
    ...
    <div class="bento-card bento-span-full">
        ...
        <p class="bento-subtext">View or remove old activity logs.</p>
            ...
            <div class="action-button-row" style="margin-top: 1.5rem;">
                <form method="post" action="../controllers/action_admin_audit_logs.php">
                    <?= $csrfField ?>
            ...
            <?php if ($auditLogs === []): ?>
                <div class="center-align" style="padding: 3rem 1rem;">
                    ...
                    <h5 class="grey-text">No Activity Logs Found</h5>
                    <p class="grey-text">There are currently no activity logs to display.</p>
                </div>
            <?php else: ?>
    ...
    <div class="bento-card bento-span-full">
        <div class="bento-card-header"><i class="material-icons">settings</i> System Settings</div>
        <p class="bento-subtext">Set the current academic year and system status.</p>

            <form method="post" action="../controllers/action_admin_config.php" style="margin-top: 1.5rem;">
                <?= $csrfField ?>
                <div class="row">
    ...
    <div class="bento-card bento-span-full">
        ...
        <p class="bento-subtext">Reset projects or clear the database for a new term.</p>
            ...
            <div class="action-button-row" style="margin-top: 1.5rem;">
                <form method="post" action="../controllers/action_admin_db_utils.php">
                    <?= $csrfField ?>
    ...
    <div class="bento-card bento-span-full">
        <div class="bento-card-header"><i class="material-icons">build</i> Database Maintenance</div>
        <p class="bento-subtext">Improve database performance.</p>

            <form method="post" action="../controllers/action_admin_optimize.php" style="margin-top: 1.5rem;">
                <?= $csrfField ?>
                <button type="submit" class="btn purple">Improve Database</button>
            </form>
        </div>
    </div>
    ...
    <div class="bento-card bento-span-full">
        ...
        <p class="bento-subtext">Create a backup of all data.</p>
            ...
            <form method="post" action="../controllers/action_admin_backup.php" style="margin-top: 1.5rem;">
                <?= $csrfField ?>
