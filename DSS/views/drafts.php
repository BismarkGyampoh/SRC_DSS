...
<?php else: ?>
    <div class="bento-card bento-span-full">
        <div class="bento-card-header"><i class="material-icons">drafts</i> <?= __('my_drafts') ?></div>
                            ...
                            <tr>
                                ...
                                <td>
                                    <form method="post" action="/dss/controllers/action_submit_draft.php" style="display: inline;">
                                        ...
                                        <button type="submit" class="btn green" style="padding: 0 1rem; height: 32px; line-height: 32px; font-size: 0.8rem;"><i class="material-icons left">send</i><?= __('submit_for_review') ?></button>
                                    </form>
                                </td>
                            </tr>
                        <?php endforeach; ?>
