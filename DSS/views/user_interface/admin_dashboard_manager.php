...
<div class="admin-page-header">
    <div class="admin-page-header-content">
        ...
        <div class="admin-page-header-text">
            <h1><?= __('dashboard_manager') ?></h1>
            <p><?= __('dashboard_manager_desc') ?></p>
        </div>
    </div>
    <div class="admin-page-actions">
            <button type="button" class="btn green" id="saveDashboardBtn">
                <i class="material-icons left">save</i><?= __('save_dashboard') ?>
            </button>
    </div>
</div>
...
<div class="admin-table-card">
    <div class="admin-table-card-header">
        <div>
            <div class="admin-table-card-title"><i class="material-icons">save</i> <?= __('save_dashboard_layout') ?></div>
            <div class="admin-table-card-subtitle"><?= __('save_dashboard_config_desc') ?></div>
        </div>
    </div>
    <div class="row" style="margin-bottom: 0;">
        <div class="col s12 m6">
            <div class="input-field">
                ...
                <label for="dashboard_name"><?= __('dashboard_name') ?></label>
            </div>
        </div>
        <div class="col s12 m6">
            <label>
...
<div class="admin-table-card">
    <div class="admin-table-card-header">
        <div>
            <div class="admin-table-card-title"><i class="material-icons">view_list</i> <?= __('my_dashboards') ?></div>
                    ...
                    <tr>
                        <td colspan="4">
                            <div class="admin-empty-state">
                                <i class="material-icons">dashboard</i>
                                <h4><?= __('no_dashboards_saved') ?></h4>
                                <p><?= __('save_first_dashboard') ?></p>
                            </div>
                        </td>
                    </tr>
                <?php else: ?>
...
<div class="admin-table-card">
    <div class="admin-table-card-header">
        <div>
            <div class="admin-table-card-title"><i class="material-icons">widgets</i> <?= __('current_dashboard_widgets') ?></div>
