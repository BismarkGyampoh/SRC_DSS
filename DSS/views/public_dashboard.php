...
<div class="bento-card bento-span-full">
        <div class="bento-card-header"><i class="material-icons">filter_list</i> <?= __('filter_projects') ?></div>
    <form method="get" action="public_dashboard.php" style="margin-top: 1rem;">
        <div class="row">
            <div class="input-field col s12 m3">
                <input type="text" id="search" name="search" value="<?= htmlspecialchars($search, ENT_QUOTES, 'UTF-8') ?>" placeholder="<?= __('search_by_title') ?>">
...
<div class="bento-grid">
    <div class="bento-card">
        <div class="bento-card-header"><i class="material-icons">check_circle</i> <?= __('approved_projects') ?></div>
        <div class="bento-metric"><?= count($acceptedProjects) ?></div>
        <p class="bento-subtext"><?= __('projects_currently_funded') ?></p>
    </div>
    <div class="bento-card">
        <div class="bento-card-header"><i class="material-icons">payments</i> <?= __('total_budget_used') ?></div>
        <div class="bento-metric"><?= number_format($totalAcceptedBudget, 2) ?></div>
        <p class="bento-subtext">GHS total budget allocated</p>
    </div>
    <div class="bento-card">
        <div class="bento-card-header"><i class="material-icons">feedback</i> <?= __('student_reports') ?></div>
...
<div class="bento-card bento-span-full">
    ...
    <p class="bento-subtext"><?= __('projects_approved_desc') ?></p>
        <div class="action-button-row" style="margin-top: 1rem;">
            <a href="/dss/controllers/action_export_csv.php?type=projects" class="btn blue"><i class="material-icons left">file_download</i><?= __('export_projects_csv') ?></a>
        </div>
        <?php if ($acceptedProjects === []): ?>
            <div class="center-align" style="padding: 3rem 1rem;">
                <i class="material-icons large grey-text text-lighten-2">folder_open</i>
                    <h5 class="grey-text"><?= __('no_approved_projects') ?></h5>
    ...
    <?php if ($feedbackItems === []): ?>
        <div class="center-align" style="padding: 3rem 1rem;">
            <i class="material-icons large grey-text text-lighten-2">feedback</i>
                    <h5 class="grey-text"><?= __('no_reports_yet') ?></h5>
...
<div class="bento-card bento-span-full" id="feedback">
    ...
    <form method="post" action="/dss/controllers/action_feedback.php" style="margin-top: 1.25rem;">
        ...
        <div class="row">
            ...
            <div class="input-field col s12">
                ...
                <label for="feedback_text"><?= __('your_comments') ?></label>
            </div>
        </div>
        <button type="submit" class="btn green"><i class="material-icons left">send</i><?= __('submit_report') ?></button>
    </form>
</div>
