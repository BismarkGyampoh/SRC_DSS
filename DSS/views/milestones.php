...
<?php else: ?>
    ...
    <?php elseif ($project !== null): ?>
        <div class="bento-card bento-span-full">
            ...
            <p class="bento-subtext"><?= __('milestones_for_project') ?> #<?= (int) $project['project_id'] ?> (<?= htmlspecialchars($project['dss_status'], ENT_QUOTES, 'UTF-8') ?>)</p>
            <?php if ($milestones === []): ?>
                <div class="center-align" style="padding: 3rem 1rem;">
                    <i class="material-icons large grey-text text-lighten-2">flag</i>
                    <h5 class="grey-text"><?= __('no_milestones') ?></h5>
            ...
            <?php else: ?>
                ...
                <div style="margin-top: 2rem;">
                    <h5 style="color: #025928; margin-bottom: 1rem;"><i class="material-icons left">calendar_today</i> <?= __('calendar_view') ?></h5>
                    <?php
                    ...
                    <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 1rem;">
                        ...
                        <strong style="font-size: 1.1rem;"><?= $monthStart->format('F Y') ?></strong>
                            <a href="?project_id=<?= (int) $projectId ?>&cal_month=<?= $nextMonth->format('Y-m') ?>" class="btn grey" style="padding: 0 0.75rem; height: 32px; line-height: 32px; font-size: 0.8rem;"><?= __('next_month') ?><i class="material-icons right">chevron_right</i></a>
                    </div>
