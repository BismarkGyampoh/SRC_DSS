...
<?php else: ?>
    ...
    <div class="bento-card bento-span-full">
        ...
        <div class="action-button-row" style="margin-top: 1.5rem;">
            ...
            <a href="/dss/controllers/action_export_csv.php?type=activity" class="btn green"><i class="material-icons left">file_download</i><?= __('export_activity_logs') ?></a>
    ...
    <div class="bento-card bento-span-full">
        ...
        <div class="action-button-row" style="margin-top: 1.5rem;">
            ...
            <a href="/dss/views/activity_feed.php" class="btn teal"><i class="material-icons left">history</i><?= __('activity_feed') ?></a>
        </div>
    </div>
