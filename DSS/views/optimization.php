...
<div class="bento-card bento-span-full">
        <div class="bento-card-header"><i class="material-icons">filter_list</i> <?= __('advanced_filters') ?></div>
        <p class="bento-subtext"><?= __('filter_projects_desc') ?></p>
        <form method="get" action="optimization.php" style="margin-top: 1rem;">
            <div class="row">
                <div class="input-field col s12 m3">
                    <input type="text" id="search" name="search" value="<?= htmlspecialchars($search, ENT_QUOTES, 'UTF-8') ?>" placeholder="<?= __('search_projects') ?>">
                ...
                <div class="col s12" style="margin-top: 0.5rem;">
                    <button type="submit" class="btn blue"><i class="material-icons left">search</i><?= __('apply_filters') ?></button>
    ...
    <div class="bento-card bento-span-full">
        <div class="bento-card-header"><i class="material-icons">check_circle</i> <?= __('project_selection_tool') ?></div>
    ...
    <div class="bento-card bento-span-full">
        ...
        <div style="margin-top: 0.75rem;">
            <a href="/dss/controllers/action_export_csv.php?type=projects" class="btn grey"><i class="material-icons left">download</i><?= __('export_projects_csv') ?></a>
            ...
            <?php if ($allProjects === []): ?>
                <div class="center-align" style="padding: 3rem 1rem;">
                    ...
                    <h5 class="grey-text"><?= __('no_projects_to_change') ?></h5>
    ...
    <div class="bento-card bento-span-full">
        <div class="bento-card-header"><i class="material-icons">comment</i> <?= __('project_comments') ?></div>
    ...
    <div class="bento-card bento-span-full">
        <div class="bento-card-header"><i class="material-icons">star</i> <?= __('project_ratings') ?></div>
        ...
        <div style="margin-top: 1rem;">
            ...
            <?php else: ?>
                <div class="responsive-html">
                    <table class="striped highlight">
                        <thead><tr><th><?= __('project') ?></th><th><?= __('average_rating') ?></th><th><?= __('votes') ?></th></tr></thead>
                        <tbody>
...
document.querySelectorAll('.star-btn').forEach(function(btn) {
    ...
    <div class="bento-card bento-span-full">
        <div class="bento-card-header"><i class="material-icons">attach_money</i> <?= __('budget_volunteer_tracking') ?></div>
            ...
            <div class="responsive-table-shell">
                <table class="striped highlight">
                    <thead>
                        <tr>
                            <th><?= __('project') ?></th>
                            <th><?= __('budget_required') ?></th>
                            <th><?= __('actual_budget') ?></th>
                            <th><?= __('budget_variance') ?></th>
                            <th><?= __('planned_hours') ?></th>
                            <th><?= __('actual_hours') ?></th>
                            <th><?= __('save') ?></th>
                        </tr>
                    </thead>
                    <tbody>
