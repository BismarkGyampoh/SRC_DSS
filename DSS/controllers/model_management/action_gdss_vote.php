...
// Auto-normalize the selected importance levels (1-4) into weights that sum to 1.0.
$reachWeight = round($rawReach / $totalRaw, 4);
$speedWeight = round($rawSpeed / $totalRaw, 4);
