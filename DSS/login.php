...
<body class="login-page">
    <div class="login-card">
        <div class="login-header">
            <img src="public/images/logo.png" alt="UMaT SRC Logo" style="max-width: 200px; margin-bottom: 1rem; filter: drop-shadow(0 2px 4px rgba(0,0,0,0.2));">
        ...
        <div class="login-body">
            ...
            <?php if (isset($alreadyLoggedIn)): ?>
                <div class="alert" style="background: rgba(245, 158, 11, 0.15); border-color: rgba(245, 158, 11, 0.5); color: #fbbf24; margin-bottom: 1.25rem;">
                    ...
                    <form method="post" action="controllers/login_action.php" style="display: inline; margin-top: 0.75rem;">
            ...
            <?php else: ?>
                <form method="post" action="controllers/login_action.php" autocomplete="on">
                <input
                    type="hidden"
                    name="csrf_token"
        ...
        <div class="login-footer">
            <a href="views/public_dashboard.php" style="color: rgba(255,255,255,0.7); text-decoration: none; font-size: 0.75rem;">
